...
Unicorn x Rainbow', 60.00, 'this sweater is perfect for your children. the sweater is really comfortable and the material has a resistance against liquids, so if your child spills a drink it will bouns right off this amazing unicorn sweater!', 'Man & Vrouw', '816905633-0', 1);
insert into products (name,price, description, geslacht, code, maten_id) values ('Jordan 1 high x Travis Scott ', 2238.00, 'The Travis Scott x Air Jordan 1 High OG is the limited edition collaboration from the rap superstar and Jordan Brand on the iconic silhouette that features a major twist.', 'Man', '077030122-3', 5);
...
insert into products (name,price, description, geslacht, code, maten_id) values (' Essential T shirt ' , 160.99, 'Essential T shirt is a super soft, oversized T that’s perfect for lounging around the house or wearing out and about.It’s made of our signature cotton-blend fabric with the right amount of stretch so you can move freely without restriction.','Man & Vrouw', '492662523-7', 2); 
insert into products (name, price, description, geslacht, code, maten_id) values ('cargo pants', 40.00, 'these cargo pants are special for people in the army. it has a lot of pockets and the material is indestructable. ', 'Man', '816905633-0', 4);
insert into products (name, price, description, geslacht, code, maten_id) values ('New Balance 550 pine green', 260.00, 'Aimé Leon Dores New Balance P550 is seen in four white-based colourways, with yellowed accents that give it a vintage feel.' , 'Man & Vrouw', '816905633-0', 5);
