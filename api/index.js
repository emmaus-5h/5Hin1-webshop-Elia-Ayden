...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, products.geslacht, maat.maten FROM products JOIN maat ON products.maten_id = maat.id ORDER BY products.name')
